...
def main():
    ...
    length_limit = 10 * 1000  # 拆分后每段不得超过1分钟
...
def prepare_for_baiduaip(name, sound, silence_thresh=-30, min_silence_len=700, length_limit=10 * 1000,
...
def chunk_split_length_limit(chunk, min_silence_len=700, length_limit=60 * 1000, silence_thresh=-30, level=0):
    '''
